...
<head>
    ...
    <title>Login Professor - EtecFlix</title>
    ...
    <section class="h-4/5 flex flex-col justify-around">
        ...
        <form method="post" action="" class="bg-black/80 w-4/5 lg:w-3/6 mx-auto p-3 md:p-5 rounded-md">
            ...
            <fieldset class="flex flex-col space-y-3">
                ...
                <input type="text" placeholder="Login: nome.sobrenome" required class="bg-input-netflix input-check focus:ring-1 focus:invalid:ring-red-netflix focus:valid:ring-green-600 rounded-md text-white placeholder:text-gray-netflix text-md md:text-xl border-none">

                <input type="password" placeholder="Matrícula" required class="bg-input-netflix input-check focus:ring-1 focus:invalid:ring-red-netflix focus:valid:ring-green-600 rounded-md text-white placeholder:text-gray-netflix text-md md:text-xl border-none">
